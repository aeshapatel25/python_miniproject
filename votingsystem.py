nominee1 = input("Enter name of 1st nominee: ")
nominee2 = input("Enter name of  2nd nominee: ")
...
while True:
    if voter_id == []:
        ...
        if nm1_votes > nm2_votes:
          ...
          print("both have equal number of votes !!! Government wll dcided who will rule")
          break;  
